...
class ODBCParserFunctionsTest extends TestCase {
	...
	public function testEscapeTemplateParamPipe(): void {
		...
		// str_replace chains: '|' → '{{!}}', then '}}' in '{{!}}' → '&#125;&#125;'.
		// This is a known interaction of the sequential str_replace approach.
	...
	public function testEscapeTemplateParamTripleBrace(): void {
		...
		// str_replace chains: '}}' escapes first two braces in '}}}', then '{{{' → entities.
